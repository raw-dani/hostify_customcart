...
<div id="order-standard_cart">
    ...
    <div class="row">
        ...
        <div class="cart-body">
            {if $productinfo.group_name eq 'Google Workspace'}
                <a href="https://workspace.eikontechnology.com/pricing" class="btn btn-primary" style="margin-bottom: 30px;">Back To Pricing</a>
            {/if}
            <div class="header-lined">
                <h1 class="font-size-36">{$LANG.domaincheckerchoosedomain}</h1>                
                <h3>{$productinfo.group_name} - {$productinfo.name}</h3> 
                
                
            </div>
            {include file="orderforms/hostify_customcart/hostify-sidebar-categories-selector.tpl"}
            <form id="frmProductDomain">
                ...
                <div class="domain-selection-options">
                    ...
                    {if $owndomainenabled}
                        <div class="option" 
                        {* {if $productinfo.group_name eq 'Google Workspace'}style="display:none"{/if} *}
                        >
                            <label>
                                <input type="radio" name="domainoption" value="owndomain" id="selowndomain"{if $domainoption eq "owndomain"} checked{/if} />{$LANG.cartexistingdomainchoice|sprintf2:$companyname} I will use my existing domain
                            </label>
                    ...
                    {if $subdomains}
                        <div class="option">
                            <label>
                                <input type="radio" name="domainoption" value="subdomain" id="selsubdomain"{if $domainoption eq "subdomain"} checked{/if} />{$LANG.cartsubdomainchoice}
                            </label>
            ...
            {* {if $productinfo.group_name eq 'Google Workspace'}
                <a href="{$smarty.server.PHP_SELF}?a=add&pid=2&skipconfig=1" class="btn btn-primary" style="margin-bottom: 30px;">Use my domain/sub-domain</a>
            {/if} *}
