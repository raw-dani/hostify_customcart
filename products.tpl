                            ...
                            <div class="pricing-box pricing-box-simple pricing-color{$counter}{if $product.isFeatured} bestbuy{/if}" style="width: 100%">
                                <div class="pricing-content">
                                                        ...
                                                        <div class="pricing-options">
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div id="monthly{$product@iteration}" class="tab-pane fade in active">
                                                                    {math assign="persen" equation='x/y*h' y=100 x=30 h=$product.pricing.minprice.price}
                                                                    {math assign="hargadiskon" equation='y-x' y=$product.pricing.minprice.price x=$persen}
                                                                    {* {$product.pricing.rawpricing.monthly |@print_r} *}
                                                                    <div class="pricing-price">{$product.pricing.minprice.price->toPrefixed()}
                                                                    </div>
                                    ...
                                    <div class="pricing-link">
                                        ...
                                        {else}
                                            <a class="ybtn" href="{$WEB_ROOT}/cart.php?a=add&{if $product.bid}bid={$product.bid}{else}pid={$product.pid}{/if}" class="btn btn-success btn-sm" id="product{$product@iteration}-order-button">
                                                {$LANG.ordernowbutton}
                                            </a>
                                        {/if}
                                    </div>
